...
if response.status_code == 200:
    ...
    product_details_response = session.get(services_url)
    soup = BeautifulSoup(product_details_response.content, "html.parser")
    # Find all <td> tags
    td_tags = soup.find_all("td", attrs={"data-domain": True, "data-element-id": True})
    ...
    # Iterate over the product details URLs
